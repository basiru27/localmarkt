...
export default function MyListings() {
      ...
      .on(
        ...
        (payload) => {
          ...
          if (record && (record.seller_id === user.id || record.user_id === user.id)) {
            queryClient.invalidateQueries({ queryKey: listingKeys.list({ mine: true, limit: 10, page, ...filters }), exact: false });
          }
        }
      )
      .subscribe();
  ...
  }, [user?.id, queryClient, filters, page]);
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-2 mt-3 justify-end sm:justify-start">
                      ...
                      >
                        ...
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-gray-800 text-white text-[10px] rounded opacity-0 group-hover:opacity-100 whitespace-nowrap pointer-events-none transition-opacity">View</span>
                      </Link>
                      {!listing.is_sold && (
                        <Link
                        ...
                        >
                          ...
                          <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-gray-800 text-white text-[10px] rounded opacity-0 group-hover:opacity-100 whitespace-nowrap pointer-events-none transition-opacity">Edit</span>
                        </Link>
                      )}
                      {!listing.is_sold && (
                        <button
                        ...
                        >
                          ...
                          <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-gray-800 text-white text-[10px] rounded opacity-0 group-hover:opacity-100 whitespace-nowrap pointer-events-none transition-opacity">Delete</span>
                        </button>
                      )}
                    </div>
                  </div>
