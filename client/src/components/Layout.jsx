...
function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full flex items-center justify-center text-white bg-[#C8622A] hover:bg-[#B5561F] shadow-lg transition-all duration-300 ${
