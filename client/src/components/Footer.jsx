          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-extrabold bg-gradient-to-r from-primary to-teal-600 bg-clip-text text-transparent">
                  LocalMarkt
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a 
                href="#" 
                className="w-9 h-9 rounded-lg bg-white border border-border flex items-center justify-center text-text-secondary hover:text-primary hover:border-primary transition-colors"
                aria-label="Facebook"
              >
