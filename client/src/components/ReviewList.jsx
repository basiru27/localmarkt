    ...
    return (
      <div className="card-static p-4 sm:p-5">
        ...
        <div className="text-center py-8">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-orange-50 text-orange-400 flex items-center justify-center">
          ...
          {!isAuthenticated && (
            <Link to="/login" state={{ from: { pathname: `/listings/${listingId}` } }} className="btn-primary">
